...
import com.example.androideatit.Callback.MyButtonClickListener;
...
public abstract class MySwiperHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private GestureDetector.SimpleOnGestureListener gettureListener = new GestureDetector.SimpleOnGestureListener(){
    ...
    public MySwiperHelper(Context context, RecyclerView recyclerView, int buttonWidth) {
        ...
        this.gestureDetector = new GestureDetector(context, gettureListener);
